# Service_ETL_Pipeline

This folder defines all source code for the 'Service_ETL_Pipeline' pipeline:
...
* Take a look at the sample under "sample_users_service_etl_pipeline.py" to get familiar with the syntax.

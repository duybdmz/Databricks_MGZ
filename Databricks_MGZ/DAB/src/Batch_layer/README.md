...
This folder defines all source code for the 'Batch_layer' pipeline:
...
* Take a look at the sample under "sample_users_batch_layer.py" to get familiar with the syntax.
